...
datadir = "train-data/"
checkpoints_dir = "checkpoints-256/"
logs_dir = "logs-256/"

data_di = "/misc/export3/shakeel/multimodal/algo-all-data-4/train-data/data/"
true_geos_train = pd.read_csv(data_di + "geo_a_train.csv", header = None)
true_audios_train = pd.read_csv(data_di + "aud_a_train.csv", header = None)
wrong_geos_train = pd.read_csv(data_di + "geo_b_train.csv", header = None)
wrong_audios_train = pd.read_csv(data_di + "aud_b_train.csv", header = None)
label_train = pd.read_csv(data_di + "label_train.csv", header = None)

true_geos_val = pd.read_csv(data_di + "geo_a_valid.csv", header = None)
true_audios_val = pd.read_csv(data_di + "aud_a_valid.csv", header = None)
wrong_geos_val = pd.read_csv(data_di + "geo_b_valid.csv", header = None)
wrong_audios_val = pd.read_csv(data_di + "aud_b_valid.csv", header = None)
label_val = pd.read_csv(data_di + "label_valid.csv", header = None)
...
val_dataloader = DataLoader(valid_dataset, batch_size=batch_size,num_workers=20,shuffle=True)
